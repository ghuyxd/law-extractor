"""
Processor cho văn bản loại "Nghị định"
"""
...
class NghiDinhProcessor(BaseProcessor):
    """Processor chuyên xử lý văn bản Nghị định"""
