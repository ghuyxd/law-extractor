"""
Processor cho văn bản loại "Công văn"
"""
...
class CongVanProcessor(BaseProcessor):
    """Processor chuyên xử lý văn bản Công văn"""
