"""
Processor cho văn bản loại "Quyết định"
"""
...
class QuyetDinhProcessor(BaseProcessor):
    """Processor chuyên xử lý văn bản Quyết định"""
