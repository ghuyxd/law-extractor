"""
Processor cho văn bản loại "Chỉ thị"
"""
...
class ChiThiProcessor(BaseProcessor):
    """Processor chuyên xử lý văn bản Chỉ thị"""
